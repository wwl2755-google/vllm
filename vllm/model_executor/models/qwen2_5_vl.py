...
class Qwen2_5_VLForConditionalGeneration(nn.Module, SupportsMultiModal,
    ...
    def get_multimodal_embeddings(self,
        ...
        # logger.info(f"[DEBUG] multimodal_embeddings: {multimodal_embeddings[0]}, shape: {multimodal_embeddings[0].shape}, dtype: {multimodal_embeddings[0].dtype}")
    ...
    def get_input_embeddings(
        ...
        logger.info(f"[DEBUG] mm embeddings: {multimodal_embeddings[0]}, shape: {multimodal_embeddings[0].shape}, dtype: {multimodal_embeddings[0].dtype}")
        ...
        logger.info(f"[DEBUG] inputs_embeds: {inputs_embeds}, shape: {inputs_embeds.shape}, dtype: {inputs_embeds.dtype}")
